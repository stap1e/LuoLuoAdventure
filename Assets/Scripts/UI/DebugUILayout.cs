...
namespace LuoLuoTrip.UI
{
    ...
    {
        public static readonly Rect CommanderHud = new Rect(10, 150, 320, 300);
        public static readonly Rect ControlHint = new Rect(10, 70, 400, 120);
        ...
        public static readonly Rect MissionChainSummary = new Rect(10, 400, 400, 250);
        public static readonly Rect FactionStanding = new Rect(Screen.width - 330, 150, 320, 400);
