...
namespace LuoLuoTrip
{
    public class CommanderControlRuntimeState
    {
        ...
        public float LastControlAttemptTime;
        public string LastControlRejectReason;
        public string LastSelectedTargetName;
        public int LastSelectedTargetRank;
        public int LastSelectedTargetRequiredLevel;
        public int LastSelectedTargetTrust;
        public bool LastSelectedTargetIsLeader;
        public bool LastSelectedTargetAllowDirectControl;
        public bool LastSelectedTargetAllowTacticalCommand;
        public int LastCommanderLevel;
        public string LastInputRoute;
        public string LastSuggestion;
        public bool LastDirectControlAllowed;
        public bool LastTacticalCommandAllowed;
        public bool LastSyncAssistAllowed;
        public bool LastDefendObjectiveAllowed;
        public bool LastFocusFireAllowed;
        public string LastDefendObjectiveReason;
        public string LastFocusFireReason;
        public int LastResponderCount;
        public string LastObjectiveTargetName;
        public string LastFocusTargetName;
        public bool LastAttemptHadSelectedTarget;
        public CharacterEntity LastAutoAcquiredTarget;
