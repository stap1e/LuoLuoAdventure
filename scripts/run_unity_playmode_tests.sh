...
# Usage: ./run_unity_playmode_tests.sh [UNITY_PATH] [TEST_FILTER] [TIMEOUT_SECONDS]
#
set -euo pipefail
...
XML_PATH="$RESULTS_DIR/playmode-results.xml"
LOG_PATH="$RESULTS_DIR/playmode-editor.log"
